...
Toggle.ZIndex = 2
Toggle.Image = "https://www.roblox.com/Thumbs/Asset.ashx?width=420&height=420&assetId=73430006430998"
...
TabSelection.Image = "73430006430998"
	...
	do -- Resize Window
		...
		Resizer.MouseEnter:Connect(function()
			...
			if options.can_resize then
				oldIcon = mouse.Icon
				-- mouse.Icon = "http://www.roblox.com/asset?id=73430006430998"
			end
			Entered = true
		end)
